...
## Switches
set_property PACKAGE_PIN V17 [get_ports {triggerSwitch}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {triggerSwitch}]
set_property PACKAGE_PIN V16 [get_ports {shiftYSwitch}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {shiftYSwitch}]
...
#set_property PACKAGE_PIN R2 [get_ports {triggerSwitch}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {triggerSwitch}]
